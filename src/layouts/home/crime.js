...
class Crime extends Component {
    ...
    render() {
        // for (const categorys of this.state.categorys.Movies_Categorys_Reducer) {
        //     this.setState({
        //         category_name: Object.keys(categorys).find(c => c === "crime").toUpperCase().substr(0, 1).toUpperCase() + Object.keys(categorys).find(c => c === "crime").substr(1)
        //     })
        // }
        ...
        return (
            <div>
                {Object.values(this.state.categorys.Movies_Categorys_Reducer).map((categorys, i) => (
                    <Fragment key={i}>
                        {categorys.crime.length >= 4 ?
                            <Fragment key={i}>
                                <div className="row-header">
                                    <div className="rowTitle">
                                        <div className="row-header-title" key={Object.keys(categorys).find(c => c === "crime")}>
                                            {Object.keys(categorys).find(c => c === "crime").toUpperCase().substr(0, 1).toUpperCase() + Object.keys(categorys).find(c => c === "crime").substr(1)}
                                        </div>
                                    </div>
                                </div>
                                <div className='top'>
                                    <Slider {...settings} key={Object.keys(categorys).find(c => c === "crime")} >
