        ...
        return (
            <div>
                {Object.values(this.state.categorys.Movies_Categorys_Reducer).map((categorys, i) => (
                    <Fragment key={i}>
                        {categorys.family === undefined ? null :
                            categorys.family.length >= 4 ?
                                <Fragment key={i}>
                                    ...
                                    <div className='top'>
                                        <Slider {...settings} key={Object.keys(categorys).find(c => c === "for_childern_and_the_whole_family")} >
                                            {categorys.for_childern_and_the_whole_family.map(movie => (movie.photos.map(photo => (
                                                                    ...
                                                                    <div className="btnBackround">
                                                                        <button className="btn"
                                                                            onClick={() => {
                                                                                this.setState({
                                                                                    find: movie,
                                                                                    find_category: categorys.for_childern_and_the_whole_family
                                                                                })
                                                                            }}> ^
                                                                </button>
                                                                    </div>
                                        ...
                                        {this.call_cart_movie(categorys.for_childern_and_the_whole_family)}
                                    </div>
                                </Fragment>
                                : null}
                    </Fragment>
