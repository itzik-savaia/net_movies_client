                ...
                {Object.values(this.state.categorys.Movies_Categorys_Reducer).map((categorys, i) => (
                    <Fragment key={i}>
                        {categorys.fantasys === undefined ? null :
                            categorys.fantasys.length >= 4 ?
                                <Fragment key={i}>
                                    <div className="row-header">
                                        <div className="rowTitle">
                                            <div className="row-header-title" key={Object.keys(categorys).find(c => c === "fantasys")}>{Object.keys(categorys).find(c => c === "fantasys")}</div>
                                        </div>
                                    </div>
                                    <div className='top'>
                                                                    ...
                                                                    <div className="btnBackround">
                                                                        <button className="btn"
                                                                            onClick={() => {
                                                                                this.setState({
                                                                                    find: movie,
                                                                                    find_category: categorys.fantasys
                                                                                })
                                                                            }}> ^
                                                                </button>
                                                                    </div>
