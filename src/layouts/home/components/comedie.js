                                ...
                                <Fragment key={i}>
                                    <div className="row-header">
                                        <div className="rowTitle">
                                            <div className="row-header-title" key={Object.keys(categorys).find(c => c === "comedies")}>{Object.keys(categorys).find(c => c === "comedies")}</div>
                                        </div>
                                    </div>
                                    <div className='top'>
                                                                    ...
                                                                    <div className="btnBackround">
                                                                        <button className="btn"
                                                                            onClick={() => {
                                                                                this.setState({
                                                                                    find: movie,
                                                                                    find_category: categorys.comedies
                                                                                })
                                                                            }}> ^
                                                                </button>
                                                                    </div>
