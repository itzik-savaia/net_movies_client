        ...
        return (
            <div>
                {Object.values(this.state.categorys.Movies_Categorys_Reducer).map((categorys, i) => (
                    <Fragment key={i}>
                        {categorys.drama === undefined ? null :
                            categorys.drama.length >= 4 ?
                                <Fragment key={i}>
                                    ...
                                    <div className='top'>
                                        <Slider {...settings} key={Object.keys(categorys).find(c => c === "drama")} >
                                            {categorys.drama.map(movie => (movie.photos.map(photo => (
                                        ...
                                        {this.call_cart_movie(categorys.drama)}
                                    </div>
                                </Fragment>
                                : null}
                    </Fragment>
