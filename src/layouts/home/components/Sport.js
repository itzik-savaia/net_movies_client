        ...
        return (
            <div>
                {Object.values(this.state.categorys.Movies_Categorys_Reducer).map((categorys, i) => (
                    <Fragment key={i}>
                        {categorys.sports === undefined ? null :
                            categorys.sports.length >= 4 ?
                                <Fragment key={i}>
                                    ...
                                    <div className='top'>
                                        <Slider {...settings} key={Object.keys(categorys).find(c => c === "sports")} >
                                            {categorys.sports.map(movie => (movie.photos.map(photo => (
                                                                    ...
                                                                    <div className="btnBackround">
                                                                        <button className="btn"
                                                                            onClick={() => {
                                                                                this.setState({
                                                                                    find: movie,
                                                                                    find_category: categorys.sports
                                                                                })
                                                                            }}> ^
                                                                </button>
                                                                    </div>
                                        ...
                                        {this.call_cart_movie(categorys.sports)}
                                    </div>
                                </Fragment>
                                : null}
                    </Fragment>
