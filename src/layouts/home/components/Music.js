        ...
        return (
            <div>
                {Object.values(this.state.categorys.Movies_Categorys_Reducer).map((categorys, i) => (
                    <Fragment key={i}>
                        {categorys.music === undefined ? null :
                            categorys.music.length >= 4 ?
                                <Fragment key={i}>
                                    ...
                                    <div className='top'>
                                        <Slider {...settings} key={Object.keys(categorys).find(c => c === "music")} >
                                            {categorys.music.map(movie => (movie.photos.map(photo => (
                                        ...
                                        {this.call_cart_movie(categorys.music)}
                                    </div>
                                </Fragment>
                                : null}
                    </Fragment>
