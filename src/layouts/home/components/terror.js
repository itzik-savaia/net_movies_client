                ...
                {Object.values(this.state.categorys.Movies_Categorys_Reducer).map((categorys, i) => (
                    <Fragment key={i}>
                        {categorys.terrors === undefined ? null :
                            categorys.terrors.length >= 4 ?
                                <Fragment key={i}>
                                    <div className="row-header">
                                        <div className="rowTitle">
                                            <div className="row-header-title" key={Object.keys(categorys).find(c => c === "terrors")}>{Object.keys(categorys).find(c => c === "terrors")}</div>
                                        </div>
                                    </div>
                                    <div className='top'>
                                                                    ...
                                                                    <div className="btnBackround">
                                                                        <button className="btn"
                                                                            onClick={() => {
                                                                                this.setState({
                                                                                    find: movie,
                                                                                    find_category: categorys.terrors
                                                                                })
                                                                            }}> ^
                                                                </button>
                                                                    </div>
